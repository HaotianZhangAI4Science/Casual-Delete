...
# python -u delete.py --surf_path ./example/Eg5/3zcw_2_pocket_8.0_res_1.5.ply --frag_path ./example/Eg5/3zcw_frag.sdf 
# --check_point ./checkpoint/ckpt/val_119.pt --outdir ./outputs --suboutdir my_name --ligand_file ./example/cb1/Gi_lig.sdf --protein_file ./example/cb1Gi_protein_fix.pdb
import os
import argparse
